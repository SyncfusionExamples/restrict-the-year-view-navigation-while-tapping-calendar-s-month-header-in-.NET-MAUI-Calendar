...
This sample contains a sample to restrict the year view navigation while tapping calendar’s month header in the [SfCalendar](https://help.syncfusion.com/maui/calendar/getting-started) control.
